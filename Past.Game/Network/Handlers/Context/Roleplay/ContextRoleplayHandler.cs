...
namespace Past.Game.Network.Handlers.Context.Roleplay
{
    public class ContextRoleplayHandler
    {
        ...
        {
            client.Send(new MapComplementaryInformationsDataMessage(client.Character.Map.Id, (short)client.Character.Map.SubAreaId, new HouseInformations[0], new GameRolePlayActorInformations[0], client.Character.CurrentMap.GetInteractiveElements(client.Character.Map.Id), new StatedElement[0], new MapObstacle[0], new FightCommonInformations[0]));
